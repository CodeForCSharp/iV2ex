...
namespace MyToolkit.Paging
{
    ...
    public class MtFrame : Control, INavigate
    {
        ...
        /// <summary>
        ///     Gets or sets a value indicating whether to show the animation when launching, leaving or switching to the app.
        ///     Default: false.
        /// </summary>
        public bool ShowNavigationOnAppInAndOut { get; set; }

        /// <summary>
        ///     Gets or sets a value indicating whether the forward stack is disabled
        ///     (default: disabled on Windows Phone, enabled on Windows).
        /// </summary>
        public bool DisableForwardStack { get; set; }

        /// <summary>
        ///     Gets or sets a value indicating whether the cache is fully
        ///     deactivated (should be used only for testing). Default: false.
        /// </summary>
        ...
        public static MtFrame Current => Window.Current.Content as MtFrame;

        /// <summary>
        ///     Gets or sets a value indicating whether the back button is automatically shown and hidden by the frame
        ///     (default: true).
        /// </summary>
        ...
        public MtPageDescription PreviousPage => _pageStackManager.PreviousPage;

        /// <summary>Gets the current page. </summary>
        public MtPageDescription CurrentPage => _pageStackManager.CurrentPage;

        /// <summary>Gets the page after the current page in the page stack or null if not available. </summary>
        public MtPageDescription NextPage => _pageStackManager.NextPage;
        ...
        public IReadOnlyList<MtPageDescription> Pages => _pageStackManager.Pages;
        ...
        ///     May be overridden by the current page's PageAnimation property.
        /// </summary>
        ...
        private IPageAnimation ActualPageAnimation
        {
            get
            {
                ...
                return currentPage?.Page?.PageAnimation != null ? CurrentPage.Page.PageAnimation : PageAnimation;
            }
        }
        ...
        public async void Initialize(Type homePageType, object parameter = null)
        {
            await NavigateAsync(homePageType, parameter);
        }
        ...
        /// <remarks>
        ///     If the page exists it is referenced multiple times in the page stack:
        ///     The <see cref="MtPageDescription" /> is contained multiple times in the page stack.
        /// </remarks>
        /// <param name="pageType">The page type. </param>
        ...
        private async Task GoForwardOrBackAsync(NavigationMode navigationMode)
        {
            ...
            {
                var currentPage = CurrentPage;
                var nextPageIndex = _pageStackManager.CurrentIndex +
                                    (navigationMode == NavigationMode.Forward ? 1 : -1);
        ...
        private void SwitchPagesIfSequential(PageInsertionMode insertionMode, MtPageDescription currentPage,
            MtPageDescription newPage)
        {
        ...
        public static readonly DependencyProperty ContentTransitionsProperty = DependencyProperty.Register(
            "ContentTransitions", typeof(TransitionCollection), typeof(MtFrame),
        ...
        private async Task AnimateNavigatedToAndRemoveCurrentPageAsync(IPageAnimation pageAnimation,
            NavigationMode navigationMode, PageInsertionMode insertionMode, MtPageDescription currentPage,
            MtPageDescription newPage)
        {
            if (currentPage != null)
                if (insertionMode != PageInsertionMode.Sequential)
        ...
        private async Task<bool> RaisePageOnNavigatingFromAsync(MtPageDescription currentPage,
            MtPageDescription nextPage, NavigationMode mode)
        {
