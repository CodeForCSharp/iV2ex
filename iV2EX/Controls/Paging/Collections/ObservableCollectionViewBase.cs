...
namespace MyToolkit.Collections
{
    ...
    public abstract class ObservableCollectionViewBase<TItem> : IList<TItem>, IDisposable, IList,
        INotifyCollectionChanged, INotifyPropertyChanged
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="ObservableCollectionViewBase{TItem}" /> class. </summary>
        /// <param name="items">The source item list. </param>
        /// <param name="trackItemChanges">
        ///     The value indicating whether to track items which implement
        ...
        public void AddRange(IEnumerable<TItem> items)
        {
            ...
            if (Items is MtObservableCollection<TItem> collection)
        ...
        private void RegisterEvent(INotifyPropertyChanged item)
        {
            ...
            var handler = WeakEvent
                .RegisterEvent<ObservableCollectionViewBase<TItem>, PropertyChangedEventHandler,
        ...
        {
            if (Items is ObservableCollection<TItem> items)
            {
                var collection = items;
                _itemsChangedHandler = WeakEvent
                    .RegisterEvent<ObservableCollectionViewBase<TItem>, NotifyCollectionChangedEventHandler,
