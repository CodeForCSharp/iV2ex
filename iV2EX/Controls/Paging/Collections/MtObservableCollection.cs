...
{
    /// <summary>
    ///     Provides a safe collection changed event which always provides the added
    ///     and removed items, some more events and more range methods.
    /// </summary>
    ...
    public class MtObservableCollection<T> : ObservableCollection<T>
    {
        ...
        /// <summary>
        ///     Gets or sets a value indicating whether to provide the previous collection in the extended collection changed
        ///     event.
        ///     Enabling this feature may have a performance impact as for each collection changed event a copy of the collection
        ///     gets created.
        /// </summary>
        ...
        public void RemoveRange(IEnumerable<T> collection)
        {
            ...
            OnPropertyChanged(new PropertyChangedEventArgs("Count"));
            OnCollectionChanged(
                new NotifyCollectionChangedEventArgs(NotifyCollectionChangedAction.Remove, collection));
        }
        ...
        /// <summary>
        ///     Raises the System.Collections.ObjectModel.ObservableCollection{T}.CollectionChanged event with the provided
        ///     arguments.
        /// </summary>
        ...
        protected override void OnCollectionChanged(NotifyCollectionChangedEventArgs e)
        {
            ...
            if (copy != null)
            {
                var oldCollection = ProvideOldCollection ? _oldCollection : null;
                ...
                foreach (var item in _oldCollection.Where(x => !Contains(x))) // deleted items
                {
