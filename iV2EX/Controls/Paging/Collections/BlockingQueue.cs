...
namespace MyToolkit.Collections
{
    ...
    public class BlockingQueue<T>
    {
        ...
        /// <param name="maximumWaitTime">
        ///     The maximum wait time until free slot is available,
        ///     if exceeded then item is not added and false is returned.
        /// </param>
        ...
        /// <param name="maximumWaitTime">
        ///     The maximum wait time to wait until an item is
        ///     available if the queue is empty. Default is -1 (indefinitely).
        /// </param>
