...
namespace MyToolkit.Utilities
{
    ...
    public static class TaskUtilities
    {
        ...
        /// <param name="param2">The second parameter. </param>
        /// <returns>The task. </returns>
        public static Task<TResult> RunCallbackMethodAsync<T1, T2, TResult>(Action<T1, T2, Action<TResult>> func,
            T1 param1, T2 param2)
        {
            var task = new TaskCompletionSource<TResult>();
        ...
        /// <returns>The task. </returns>
        public static Task RunCallbackMethodAsync<T1, T2, T3>(Action<T1, T2, T3, Action> func, T1 param1, T2 param2,
            T3 param3)
        {
            var task = new TaskCompletionSource<object>();
        ...
        /// <param name="param3">The third parameter. </param>
        /// <returns>The task. </returns>
        public static Task<TResult> RunCallbackMethodAsync<T1, T2, T3, TResult>(
            Action<T1, T2, T3, Action<TResult>> func, T1 param1, T2 param2, T3 param3)
        {
            var task = new TaskCompletionSource<TResult>();
