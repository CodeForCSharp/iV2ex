    ...
    public static class DictionaryExtensions
    {
        ...
        public static Dictionary<string, object> DeepCopy(this Dictionary<string, object> dictionary)
        {
            ...
            foreach (var p in dictionary)
                ...
                else if (p.Value is List<Dictionary<string, object>> list)
        ...
        public static ObservableDictionary<string, object> DeepCopy(
            this ObservableDictionary<string, object> dictionary)
        {
            ...
            foreach (var p in dictionary)
                ...
                else if (p.Value is ObservableCollection<ObservableDictionary<string, object>> list)
                    output[p.Key] =
                        new ObservableCollection<ObservableDictionary<string, object>>(list.Select(DeepCopy));
                else
                    output[p.Key] = p.Value;
            return output;
        }
