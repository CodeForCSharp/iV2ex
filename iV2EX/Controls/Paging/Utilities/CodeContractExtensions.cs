...
namespace MyToolkit.Utilities
{
    ...
    public static class CodeContractExtensions
    {
        ...
        /// <remarks>
        ///     The method throws a <see cref="ArgumentNullException" /> and also defines Contract.Requires statements for
        ///     static analysis.
        /// </remarks>
        [DebuggerStepThrough]
#if !LEGACY
        ...
        public static void CheckNotNullOrEmpty([ValidatedNotNull] this string value, string parameterName)
        {
            ...
            Contract.Requires<ArgumentNullException>(value != string.Empty,
                "The string '" + parameterName + "' cannot be empty. ");
#endif
        ...
        /// <remarks>
        ///     The method throws a <see cref="ArgumentNullException" /> and also defines a Contract.Requires statement for
        ///     static analysis.
        /// </remarks>
        [DebuggerStepThrough]
#if !LEGACY
