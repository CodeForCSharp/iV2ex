...
namespace MyToolkit.Paging
{
    public abstract class MtApplication : Application
    {
        ...
        public virtual Task<Type> GetStartPageTypeAsync()
        {
            return null;
        }
        ...
        /// <summary>
        ///     Creates the application's root frame and loads the first page if needed.
        ///     Also calls <see cref="OnInitializedAsync" /> when the application is instantiated the first time.
        /// </summary>
        ...
        protected async Task InitializeFrameAsync(ApplicationExecutionState executionState)
        {
            ...
            {
                var rootType = await GetStartPageTypeAsync();
                RootFrame.Initialize(rootType);
            }
