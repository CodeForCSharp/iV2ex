...
namespace MyToolkit.Mvvm
{
    ...
    public class ViewModelBase : ObservableObject
    {
        ...
        /// <summary>
        ///     Asynchronously runs an action and correctly updates the <see cref="IsLoading" /> property,
        ///     handles exceptions in the <see cref="HandleException" /> method
        ///     and automatically creates and registers a cancellation token source.
        /// </summary>
        /// <param name="task">The task to run. </param>
        ...
        public virtual void HandleException(Exception exception)
        {
            throw new NotImplementedException(
                "An exception occured in RunTaskAsync. Override ViewModelBase.HandleException to handle this exception. ",
                exception);
        }

        /// <summary>
        ///     Disposes and deregisters a <see cref="CancellationTokenSource" />.
        ///     Should be called when the task has finished cleaning up the view model.
        /// </summary>
        /// <param name="cancellationTokenSource"></param>
