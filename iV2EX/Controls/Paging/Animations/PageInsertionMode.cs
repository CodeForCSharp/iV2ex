...
namespace MyToolkit.Paging.Animations
{
    ...
    {
        /// <summary>
        ///     Inserts the next page over the previous page before starting the animations so that both pages are in the
        ///     visual tree during the animations.
        /// </summary>
        ConcurrentAbove,

        /// <summary>
        ///     Inserts the next page below the previous page before starting the animations so that both pages are in the
        ///     visual tree during the animations.
        /// </summary>
        ConcurrentBelow,
