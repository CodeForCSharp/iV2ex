...
{
    /// <summary>
    ///     Provides an attached property to enable the tilt effect (push down/up animation) for <see cref="UIElement" />
    ///     s.
    /// </summary>
    public static class TiltEffect
    {
        public static readonly DependencyProperty IsTiltEnabledProperty =
            DependencyProperty.RegisterAttached("IsTiltEnabled", typeof(bool), typeof(TiltEffect),
                new PropertyMetadata(default(bool), OnIsTiltEnabledChanged));
