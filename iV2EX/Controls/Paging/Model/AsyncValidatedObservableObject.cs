...
namespace MyToolkit.Model
{
    ...
    ///     support and async validation.
    /// </summary>
    /// <remarks>
    ///     Because the property access and validation may happen on different threads,
    ///     the class must be thread-safe. Use the <see cref="ValidatedObservableObject._lock" /> object for locking.
    /// </remarks>
    public class AsyncValidatedObservableObject : ValidatedObservableObject
    {
        ...
        /// <remarks>
        ///     In the <see cref="ValidatedObservableObject" /> override, the changing of the property is locked using the
        ///     <see cref="ValidatedObservableObject._lock" /> object.
        /// </remarks>
