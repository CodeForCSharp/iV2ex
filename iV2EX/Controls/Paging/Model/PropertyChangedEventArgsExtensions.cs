...
{
    /// <summary>
    ///     Provides extension methods to check <see cref="PropertyChangedEventArgs" /> in a type-safe manner using
    ///     lambdas.
    /// </summary>
    public static class PropertyChangedEventArgsExtensions
    {
        ...
        /// <returns><c>true</c> if the property names match; otherwise, <c>false</c>. </returns>
        public static bool IsProperty<TObject>(this PropertyChangedEventArgs args,
