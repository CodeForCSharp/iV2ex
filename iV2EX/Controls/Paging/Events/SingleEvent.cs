...
namespace MyToolkit.Events
{
    ...
    public class SingleEvent
    {
        ...
        public static Task<TEventArgs> WaitForEventAsync<TEventSource, TEventArgs>(TEventSource source,
        ...
        /// <returns>The task. </returns>
        public static void RegisterEvent<TEventSource, TEventArgs>(TEventSource source,
            Action<TEventSource, EventHandler<TEventArgs>> register,
        ...
        /// <param name="handler">The event handler. </param>
        /// <returns>The task. </returns>
        public static void RegisterRoutedEvent<TEventSource>(TEventSource source,
            Action<TEventSource, RoutedEventHandler> register,
        ...
        /// <param name="handler">The event handler. </param>
        /// <returns>The task. </returns>
        public static void RegisterEvent<TEventSource>(TEventSource source,
            Action<TEventSource, RoutedEventHandler> register,
            Action<TEventSource, RoutedEventHandler> deregister, Action<object, RoutedEventArgs> handler)
        {
            var wrapper = new SingleRoutedEventHandlerContainer();
